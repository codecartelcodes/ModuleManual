  ...
  who:  
    ...
    phase: Review the Overview  
      ...
      who:  
        ...
        stage: Learn about the Module  
          ...
          where: <a href=docs/module_concept.md target=_blank>module concept</a>  
          when:  
          who:  
            ...
            task: Learn the Module definitions  
              ...
              where: [module_definitions](docs/module_definitions.md)  
              when:  
              who:  

        stage: Learn the Method Concept  
    ...
    phase: Research the Method  
      ...
      who: ape_research_llm  
        ...
        stage: Define the Client? Questions  
          what:  
          how:  review the questions, add more that you have  
          why:  
          where:  
          when:  
          who:  

        stage: Acquire Method info from the client  
          what:  
          how: provide the detailed method (business model, business plan) ???  
          why:  
          where:  
          when:  
          who:  

            task: Get current written documentation  
              what:  
              how:  
              why:  
              where:  
        ...
        stage: reformat the method into uPlan format  
          what:  
          how:  
          why:  
          where:  
          ...
          who:  
            ...
            task: Produce the Profile Page  
              ...
              where: [Profile Page](docs/profile_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Problem Page  
              ...
              where: [Problem Page](docs/problem_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Conduct a CCA  
              ...
              where: [CCA template](docs/comprehensive_competitor_analysis.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Partner Page  
              ...
              where: [Partner Page](docs/partner_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Program Page  
              ...
              where: [Program Page](docs/program_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Profess Page  
              ...
              where: [Profess Page](docs/profess_page.md)  
              when:  
              who:  
            ...
            task: Produce the Process Page  
              ...
              where: [Process Page](docs/process_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Product Page  
              ...
              where: [Product Page](docs/product_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Promise Page  
              ...
              where: [Promise Page](docs/promise_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Persona Page  
              ...
              where: [Persona Page](docs/persona_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Passage Page  
              ...
              where: [Passage Page](docs/passage_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Protect Page  
              ...
              where: [Protect Page](docs/protect_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Pricing Page  
              ...
              where: [Pricing Page](docs/pricing_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Protest Page  
              ...
              where: [Protest Page](docs/protest_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Patrons Page  
              ...
              where: [Patrons Page](docs/patrons_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Promote Page  
              ...
              where: [Promote Page](docs/promote_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Propose Page  
              ...
              where: [Propose Page](docs/propose_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce Pitcher Page  
              ...
              where: [Pitcher Page](docs/pitcher_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Produce the Procede Page  
              ...
              where: [Procede Page](docs/procede_page.md)  
              when:  
              who: ape_research_llm  
            ...
            task: Learn the Modes  
              ...
              why:  
              where: [module_mode](docs/module_mode.md)  
              when:  
              who:  
            ...
            task: Learn the client criteria  
              ...
              how:  
              why:  
              where: [client_criteria](docs/client_criteria.md)  
              when:  
              who:  
            ...
            task: Learn the Manager requirements  
              ...
              where: [manager_requirements](docs/manager_requirements.md)  
              when:  
              who:  
            ...
            task: Learn the "Black" Financial Model  
              ...
              where: [black_finanacial_model](docs/black_finanacial_model.md)  
              when:  
              who:  
            ...
            task: Learn the Module financials  
              ...
              where: [module_financials](docs/module_financials.md)  
              when:  
              who:  
        ...
        stage: Analyze the competitors  
          ...
          who:  
            ...
            task: List the competitors  
              ...
              where: [competitors_list](docs/competitors_list.md)  
              when:  
              who:  
            ...
            task: Conduct a competitor analysis  
              ...
              where: [competitors_analysis](docs/competitors_analysis.md)  
              when:  
              who:  
            ...
            task: Collect the ad copy of the competitors  
              ...
              where: [competitors_ads](docs/competitors_ads.md)  
              when:  
              who:  
    ...
    phase: Start the Systems  
      ...
      who:  
        ...
        stage: Learn how to use this Manual  
          ...
          where: [manual_usage](docs/manual_usage.md)  
          when:  
          who:  
